...
class SimCtl {
  ...
  //public:
	...
	/* ATUL */
    friend void tick(int sig);
	/* ATUL */
    friend int StartRouter(ClientData, Tcl_Interp *, int, const char *argv[]);
	...
	friend void sendCfgToRouterId(char *routerId);
};
...
/* ATUL */
inline int SimCtl::get_assigned_port() {
